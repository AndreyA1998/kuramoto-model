...
3. Study of the phase transition, which could be measured by the rapid change of the order parameter, from a chaotic to a synchronized state depending on the coupling constant in the Kuramoto model for different types of graphs.    
4. Study of the possibility of iterative evolution of the graph adjacency matrix using the thermal annealing method in the direction of the order parameter increase, which is responsible for synchronization enhancement.
